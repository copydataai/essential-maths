...
import { adjugate, determinant, inverse, cofactor, minors } from "../utils/Matrices"
...
export function MatricesLayout() {
    const [matrix, setMatrix] = createSignal<Array<Array<number>>>(Array.from(Array(2), () => Array(2).fill(0)), {equals: false});
    const [operation, setOperation] = createSignal<Operations>(Operations.determinant);
    ...
    return (
        <main class="flex flex-col items-center justify-center space-y-4">
            ...
            <Show when={resultMemo() !== undefined} fallback={
                <span class="loading loading-spinner"></span>
            }>
                <Show when={operation() === Operations.determinant} fallback={
                    <Matrix matrix={resultMemo}/>
                }>
